<?php
/**
 * Author archive — author bio header + their posts list.
 *
    ...
    <div class="gr-wrap gr-grid">
        ...
        <section class="gr-col-main">
            ...
            <header class="gr-author-head">
                <div class="gr-author-head__avatar">
                    <?php echo get_avatar( $author ? $author->ID : 0, 96, '', '', array( 'class' => 'gr-author-head__img' ) ); ?>
                </div>
                <div class="gr-author-head__body">
