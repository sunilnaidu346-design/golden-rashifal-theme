...
<section
    class="gr-author-box"
    aria-label="<?php esc_attr_e( 'लेखक परिचय', 'golden-rashifal' ); ?>"
    itemscope
    itemtype="https://schema.org/Person"
>
    <div class="gr-author-box__inner">

        <!-- Avatar -->
        <div class="gr-author-box__avatar">
            <a href="<?php echo esc_url( $author_url ); ?>" tabindex="-1" aria-hidden="true">
                <img
                    ...
                    loading="lazy"
                    decoding="async"
                    class="gr-author-box__img"
                    itemprop="image"
                    onerror="this.onerror=null;this.src='<?php echo esc_url( get_avatar_url( $author_id, array( 'size' => 88 ) ) ); ?>';"
                />
            </a>
        </div>

        <!-- Body -->
        <div class="gr-author-box__body">
            <span class="gr-author-box__pre"><?php esc_html_e( 'इस लेख के लेखक', 'golden-rashifal' ); ?></span>
            <h3 class="gr-author-box__name" itemprop="name">
                <a href="<?php echo esc_url( $author_url ); ?>" itemprop="url">
                    <?php echo esc_html( GR_AUTHOR_NAME ); ?>
                </a>
            </h3>
            <span class="gr-author-box__role" itemprop="jobTitle"><?php echo esc_html( GR_AUTHOR_ROLE ); ?></span>
            <p class="gr-author-box__bio" itemprop="description"><?php echo esc_html( GR_AUTHOR_BIO ); ?></p>

            <!-- Social links -->
            <div class="gr-author-box__social" aria-label="<?php esc_attr_e( 'सोशल मीडिया लिंक', 'golden-rashifal' ); ?>">
                <a href="<?php echo esc_url( GR_AUTHOR_FB ); ?>" target="_blank" rel="noopener noreferrer" class="gr-author-box__social-link gr-author-box__social-link--fb" aria-label="Facebook">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="<?php echo esc_url( GR_AUTHOR_IG ); ?>" target="_blank" rel="noopener noreferrer" class="gr-author-box__social-link gr-author-box__social-link--ig" aria-label="Instagram">
                ...
                <a href="<?php echo esc_url( GR_AUTHOR_YT ); ?>" target="_blank" rel="noopener noreferrer" class="gr-author-box__social-link gr-author-box__social-link--yt" aria-label="YouTube">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                <a href="<?php echo esc_url( GR_AUTHOR_WA ); ?>" target="_blank" rel="noopener noreferrer" class="gr-author-box__social-link gr-author-box__social-link--wa" aria-label="WhatsApp">
                ...
                <a href="mailto:<?php echo esc_attr( GR_AUTHOR_EMAIL ); ?>" class="gr-author-box__social-link gr-author-box__social-link--mail" aria-label="Email">
            ...
            <!-- CTA -->
            <div class="gr-author-box__actions">
                <a class="gr-author-box__cta" href="<?php echo esc_url( $author_url ); ?>">
                    <?php esc_html_e( 'सभी लेख देखें', 'golden-rashifal' ); ?>
