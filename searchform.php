<?php
/**
 * Custom search form — used by get_search_form() and the search popup.
 *
...
<form role="search" method="get" class="gr-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    ...
    <div class="gr-search__row">
        <span class="gr-search__icon" aria-hidden="true">
        ...
        <input type="search" id="gr-s" class="gr-search__input" name="s"
               placeholder="<?php esc_attr_e( 'राशि, त्योहार या लेख खोजें…', 'golden-rashifal' ); ?>"
